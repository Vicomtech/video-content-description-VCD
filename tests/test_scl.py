...
class TestBasic(unittest.TestCase):   
    ...
    def test_camera_fisheye_projection2d4d(self):
        '''
        Same as with test_camera_cylindrical_projection2d3d but using the fisheye camera instead of the cylindrical
        '''
        vcd_file = './etc/' + openlabel_version_name + '_test_camera_projection2d3d.json'
