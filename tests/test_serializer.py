...
class TestBasic(unittest.TestCase):
    def test_json_to_proto(self):
        vcd_json_file_name = "./etc/vcd430_sample_3dod.json"
        vcd_proto_file_name = "./etc/vcd430_sample_3dod_proto_from_json.txt"

        serializer.json2proto_bin(vcd_json_file_name, vcd_proto_file_name)

    def test_proto_to_json(self):
        vcd_proto_file_name = "./etc/vcd430_sample_3dod_proto_from_json.txt"
        vcd_json_file_name = "./etc/vcd430_sample_3dod_from_proto.json"
