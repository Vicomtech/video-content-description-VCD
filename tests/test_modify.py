...
class TestBasic(unittest.TestCase):
    ...
    def test_static_dynamic_object_1(self):
        ...
        if not os.path.isfile('./etc/in/test_static_dynamic_object_1_1.json'):
            vcd.save('./etc/in/test_static_dynamic_object_1_1.json')
        ...
        if not os.path.isfile('./etc/in/test_static_dynamic_object_1_2.json'):
            vcd.save('./etc/in/test_static_dynamic_object_1_2.json')
    ...
    def test_static_dynamic_object_2(self):
        ...
        if not os.path.isfile('./etc/in/test_static_dynamic_object_2.json'):
            vcd.save('./etc/in/test_static_dynamic_object_2.json')
    ...
    def test_element_data_same_name(self):
        ...
        if not os.path.isfile('./etc/in/test_element_data_same_name.json'):
            vcd.save('./etc/in/test_element_data_same_name.json')
    ...
    def test_element_data_nested_same_name(self):
        ...
        if not os.path.isfile('./etc/in/test_element_data_nested_same_name.json'):
            vcd.save('./etc/in/test_element_data_nested_same_name.json')
