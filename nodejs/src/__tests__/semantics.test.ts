...
import vcd431_test_actions_a from '../../../tests/etc/vcd431_test_actions_a.json'
import vcd431_test_actions_b from '../../../tests/etc/vcd431_test_actions_b.json'
import vcd431_test_actions_c from '../../../tests/etc/vcd431_test_actions_c.json'
import vcd431_test_relations_1 from '../../../tests/etc/vcd431_test_relations_1.json'
import vcd431_test_relations_2 from '../../../tests/etc/vcd431_test_relations_2.json'
import vcd431_test_relations_3 from '../../../tests/etc/vcd431_test_relations_3.json'
...
test('test_semantics', () => {
    ...
    expect(vcd.stringify(false)).toBe('{"vcd":{"metadata":{"schema_version":"4.3.1"},"contexts":{"0":{"name":"Room1","type":"#Office"},"1":{"name":"","type":"#Noisy","frame_intervals":[{"frame_start":3,"frame_end":11}]}},"events":{"0":{"name":"","type":"#StartTalking","frame_intervals":[{"frame_start":3,"frame_end":3}]}},"frames":{"3":{"events":{"0":{}},"actions":{"0":{}},"contexts":{"1":{}}},"4":{"actions":{"0":{}},"contexts":{"1":{}}},"5":{"actions":{"0":{}},"contexts":{"1":{}}},"6":{"actions":{"0":{}},"contexts":{"1":{}}},"7":{"actions":{"0":{}},"contexts":{"1":{}}},"8":{"actions":{"0":{}},"contexts":{"1":{}}},"9":{"actions":{"0":{}},"contexts":{"1":{}}},"10":{"actions":{"0":{}},"contexts":{"1":{}}},"11":{"actions":{"0":{}},"contexts":{"1":{}}}},"frame_intervals":[{"frame_start":3,"frame_end":11}],"actions":{"0":{"name":"","type":"#Talking","frame_intervals":[{"frame_start":3,"frame_end":11}]}},"relations":{"0":{"name":"","type":"#Starts","rdf_subjects":[{"uid":"0","type":"event"}],"rdf_objects":[{"uid":"0","type":"action"}]},"1":{"name":"","type":"#Causes","rdf_subjects":[{"uid":"0","type":"action"}],"rdf_objects":[{"uid":"1","type":"context"}]}}}}')
});
...
test('test_actions', () => {
    ...
    expect(vcd_a.stringify(false)).toBe(new VCD(vcd431_test_actions_a, false).stringify(false))
    ...
    expect(vcd_b.stringify(false)).toBe(new VCD(vcd431_test_actions_b, false).stringify(false))
    ...
    expect(vcd_c.stringify(false)).toBe(new VCD(vcd431_test_actions_c, false).stringify(false))
});
...
test('test_relations', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_relations_1, false).stringify(false))
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_relations_2, false).stringify(false))
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_relations_3, false).stringify(false))
