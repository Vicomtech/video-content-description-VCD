...
import vcd431_test_static_dynamic_object_1_1 from '../../../tests/etc/vcd431_test_static_dynamic_object_1_1.json'
import vcd431_test_static_dynamic_object_1_2 from '../../../tests/etc/vcd431_test_static_dynamic_object_1_2.json'
import vcd431_test_static_dynamic_object_2 from '../../../tests/etc/vcd431_test_static_dynamic_object_2.json'
import vcd431_test_element_data_same_name from '../../../tests/etc/vcd431_test_element_data_same_name.json'
import vcd431_test_element_data_nested_same_name from '../../../tests/etc/vcd431_test_element_data_nested_same_name.json'
...
test('test_static_dynamic_object_1', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_static_dynamic_object_1_1, false).stringify(false))
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_static_dynamic_object_1_2, false).stringify(false))
...
test('test_static_dynamic_object_2', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_static_dynamic_object_2, false).stringify(false))
});
...
test('test_element_data_same_name', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_element_data_same_name, false).stringify(false))
});
...
test('test_element_data_nested_same_name', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_element_data_nested_same_name, false).stringify(false))
});
