...
import openlabel100_test_action_properties from '../../../tests/etc/openlabel100_test_action_properties.json'
...
test('test_action_properties', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(openlabel100_test_action_properties, false).stringify(false))
});