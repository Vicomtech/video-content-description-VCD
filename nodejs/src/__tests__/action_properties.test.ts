...
import vcd431_test_actions_with_action_data from '../../../tests/etc/vcd431_test_actions_with_action_data.json'
...
test('test_action_properties', () => {
    ...
    expect(vcd.stringify(false)).toBe(new VCD(vcd431_test_actions_with_action_data, false).stringify(false))
});