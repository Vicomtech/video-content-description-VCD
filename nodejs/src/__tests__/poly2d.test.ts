...
test('test_polygon2D', () => {
    ...
    expect(vcd.stringify(false)).toBe('{"vcd":{"frames":{},"schema_version":"4.2.1","frame_intervals":[],"objects":{"0":{"name":"someName1","type":"#Some","object_data":{"poly2d":[{"name":"poly1","val":["5","5","1","mBIIOIII"],"mode":"MODE_POLY2D_SRF6DCC","closed":false},{"name":"poly2","val":[5,5,10,5,11,6,11,8,9,10,5,10,3,8,3,6,4,5],"mode":"MODE_POLY2D_ABSOLUTE","closed":false}]},"object_data_pointers":{"poly1":{"type":"poly2d","frame_intervals":[]},"poly2":{"type":"poly2d","frame_intervals":[]}}}}}}')
});