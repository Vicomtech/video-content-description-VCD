...
test('test_create_openlabel', () => {
    ...
    */
    ...
    expect(openlabel.stringify(false)).toBe(new VCD(openlabel030_test_create_openlabel, false).stringify(false))
...
test('test_openlabel_bounding_box_points', () => {
    ...
    openlabel.addObjectData(uid1, new types.Poly2d(
            ...
            true))
    expect(openlabel.stringify(false)).toBe(new VCD(openlabel030_test_openlabel_bounding_box_points, false).stringify(false))
